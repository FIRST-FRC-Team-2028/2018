...
public class AutoOption5 extends CommandGroup {
	 ...
	 */
    public AutoOption5(PIDController pidcontroller, Drive drive, Ultrasonic ultrasonic, double wait_time, 
...
//    		If the scale is ours put cube on it
    		...
    		{
//			run autooption4 
    			addSequential(new AutoOption4( pidcontroller,  drive,  ultrasonic,  wait_time, 
   					 knobposition, left, gamedata));
    		}
//    		cross autoline
    		else
